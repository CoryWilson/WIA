...
//Draw Umbrella top here
  ...
  if(theCanvas4){
    ...
    if(ctx4){
      ...
      ctx4.beginPath();
      ctx4.arc(140,90,80,0,radians2,true);
      //ctx4.moveTo(140,90,140,120,80,120);
      ctx4.fill();
      ctx4.stroke();
...
//Draw text here
  ...
  if(theCanvas5){
    ...
    if(ctx5){
      var textString = "Hey this is an example.";

      ctx5.font = "14pt Verdana";
      ctx5.fillStyle = "red";
      ctx5.fillText(textString,50,50);
    }
  }
